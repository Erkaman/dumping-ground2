...
#define aDimi ivec2(${a.width}, ${a.height})
    ...
    void main () {
      ...
      for (int i = 0; i < aDimi.x; i++) {
        ...
        // The parts '+ 0.5 * aRcp' and '+ 0.5 * bRcp' are very important.
        // They ensure that we sample from the texel center!
        // Without those, we would sample from the top-left corner of the texel
        // which will yield correct results on some cards, but completely wrong
        // results on others!
...
#define wDim vec2(${W[0].width}, ${W[0].height})
    ...
    void main () {
      ...
      // TODO: should we do it this way, really?
